...
urlpatterns = [
    ...
    re_path(
        r"^post/(?P<slug>[\w-]+)/$", views.PostDetailView.as_view(), name="post_detail"
    ),
    re_path(
        r"^post/(?P<slug>[\w-]+)/edit/$",
    ...
    re_path(
        r"^post/(?P<slug>[\w-]+)/comment/$", views.post_comment, name="post_comment"
    ),
    re_path(r"^post/(?P<slug>[\w-]+)/like/$", views.post_like, name="post_like"),
    re_path(
        r"^post/(?P<slug>[\w-]+)/bookmark/$", views.post_bookmark, name="post_bookmark"
    ),
    ...
    path(
        "manage/comments/<int:pk>/edit/",
        views.CommentUpdateView.as_view(),
        name="comment_update",
    ),
    path(
        "manage/comments/<int:pk>/delete/",
        views.CommentDeleteView.as_view(),
        name="comment_delete",
    ),
    path("game/", views.rock_paper_scissors_game, name="game"),
    path("lotto/", views.lotto_generator, name="lotto"),
]
